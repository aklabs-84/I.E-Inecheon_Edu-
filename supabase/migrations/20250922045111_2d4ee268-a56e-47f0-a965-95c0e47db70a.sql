-- Create enum types for attendance and survey status
CREATE TYPE attendance_status AS ENUM ('present', 'absent', 'late');

-- Create attendance table for tracking student attendance
CREATE TABLE public.attendance (
  id bigint NOT NULL DEFAULT nextval('attendance_id_seq'::regclass) PRIMARY KEY,
...
CREATE TABLE public.surveys (
  id bigint NOT NULL DEFAULT nextval('surveys_id_seq'::regclass) PRIMARY KEY,
  program_id bigint NOT NULL,
  title text NOT NULL,
  description text,
...
CREATE TABLE public.survey_responses (
  id bigint NOT NULL DEFAULT nextval('survey_responses_id_seq'::regclass) PRIMARY KEY,
...
CREATE TABLE public.consent_forms (
  id bigint NOT NULL DEFAULT nextval('consent_forms_id_seq'::regclass) PRIMARY KEY,
  program_id bigint NOT NULL,
  title text NOT NULL,
...
CREATE TABLE public.consent_submissions (
  id bigint NOT NULL DEFAULT nextval('consent_submissions_id_seq'::regclass) PRIMARY KEY,
